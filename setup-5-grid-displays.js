...
async function setup5GridDisplays() {
  console.log('🚀 Setting up 5-Grid Display System...');
  ...
  try {
    ...
    console.log('✅ Connected to Display Manager');
    ...
    console.log('• Display Manager GUI: http://localhost:3002');
    ...
    console.log('\n🔧 Management:');
    console.log('• View all displays: http://localhost:3002/gui');
    console.log('• Apply 5-grid view: http://localhost:3002/gui/view/5-grid-view');
...
// Run the setup
setup5GridDisplays().catch(console.error); 